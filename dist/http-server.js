...
import { navigateTool, screenshotTool, clickTool, typeTool, evaluateTool, extractTool, waitTool, newSessionTool, closeSessionTool, getSessionInfoTool, } from './tools/index.js';
/**
 ...
 */
function registerTools(server, steelClient) {
    // Tool: New Session
    server.tool(newSessionTool.name, newSessionTool.description, newSessionTool.inputSchema.shape, async (params) => {
    ...
    // Tool: Close Session
    server.tool(closeSessionTool.name, closeSessionTool.description, closeSessionTool.inputSchema.shape, async (params) => {
    ...
    server.tool(getSessionInfoTool.name, getSessionInfoTool.description, getSessionInfoTool.inputSchema.shape, async (params) => {
    ...
    // Tool: Navigate
    server.tool(navigateTool.name, navigateTool.description, navigateTool.inputSchema.shape, async (params) => {
    ...
    // Tool: Screenshot
    server.tool(screenshotTool.name, screenshotTool.description, screenshotTool.inputSchema.shape, async (params) => {
    ...
    // Tool: Click
    server.tool(clickTool.name, clickTool.description, clickTool.inputSchema.shape, async (params) => {
        const sessionId = params.sessionId;
        if (!sessionId) {
            return {
    ...
    // Tool: Type
    server.tool(typeTool.name, typeTool.description, typeTool.inputSchema.shape, async (params) => {
        const sessionId = params.sessionId;
        if (!sessionId) {
            return {
    ...
    // Tool: Evaluate
    server.tool(evaluateTool.name, evaluateTool.description, evaluateTool.inputSchema.shape, async (params) => {
        const sessionId = params.sessionId;
        if (!sessionId) {
            return {
    ...
    // Tool: Extract
    server.tool(extractTool.name, extractTool.description, extractTool.inputSchema.shape, async (params) => {
        const sessionId = params.sessionId;
        if (!sessionId) {
            return {
    ...
    // Tool: Wait
    server.tool(waitTool.name, waitTool.description, waitTool.inputSchema.shape, async (params) => {
        const sessionId = params.sessionId;
        if (!sessionId) {
            return {
